...
public class MysqlIO {
	...
	/**
	 * Fill the {@link com.mysql.jdbc.MysqlIO#authenticationPlugins} map.
	 ...
	 * {@link Util#loadExtensions(Connection, java.util.Properties, String, String, ExceptionInterceptor)} call and adds them to the map too.
	 * 
	 ...
	 * 
	 * All plugin instances in the map are initialized by {@link Extension#init(Connection, java.util.Properties)} call
	...
	/**
	 * Add plugin to {@link com.mysql.jdbc.MysqlIO#authenticationPlugins} if it is not disabled by
	 ...
	 * @throws java.sql.SQLException if plugin is default but disabled.
	 */
	...
	/**
	 * Get authentication plugin instance from {@link com.mysql.jdbc.MysqlIO#authenticationPlugins} map by
