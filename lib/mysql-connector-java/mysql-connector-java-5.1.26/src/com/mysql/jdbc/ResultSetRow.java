...
public abstract class ResultSetRow {
	 ...
	 *         if null.
	 *         
	 * @throws java.sql.SQLException if an error occurs while retrieving the value.
	 */
	...
	protected final Date getDateFast(int columnIndex,
	...
	public abstract Date getDateFast(int columnIndex,
	 ...
	 * @throws java.sql.SQLException
	 */
	protected Date getNativeDate(int columnIndex, byte[] bits,
