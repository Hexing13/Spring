...
public class StatementImpl implements Statement {
		...
		try {
			synchronized (checkClosed().getConnectionMutex()) {
				return ((this.resultSetType == ResultSet.TYPE_FORWARD_ONLY)
						&& (this.resultSetConcurrency == ResultSet.CONCUR_READ_ONLY) && (this.fetchSize == Integer.MIN_VALUE));
			}
		} catch (SQLException e) {
			// we can't break the interface, having this be no-op in case of error is ok
	...
	/**
	 * @see com.mysql.jdbc.StatementImpl#execute(String, int)
	 */
	...
	/**
	 * @see com.mysql.jdbc.StatementImpl#execute(String, String[])
	 */
			...
			try {
				...
				try {
					...
					if (this.batchedArgs != null) {
						...
						for (commandIndex = 0; commandIndex < nbrCommands; commandIndex++) {
							try {
								...
								if (this.continueBatchOnError && 
									...
									throw new BatchUpdateException(ex
						...
						if (sqlEx != null) {
							throw new BatchUpdateException(sqlEx
	...
	/**
	 * @see com.mysql.jdbc.StatementImpl#executeUpdate(String, int)
	 */
	...
	/**
	 * @see com.mysql.jdbc.StatementImpl#executeUpdate(String, String[])
	 */
	...
	protected ResultSet getGeneratedKeysInternal(int numKeys)
			throws SQLException {
		synchronized (checkClosed().getConnectionMutex()) {
			Field[] fields = new Field[1];
			fields[0] = new Field("", "GENERATED_KEY", Types.BIGINT, 17); //$NON-NLS-1$ //$NON-NLS-2$
	...
	/**
	 * @see com.mysql.jdbc.StatementImpl#getMoreResults(int)
	 */
	...
	public ResultSet getResultSet() throws SQLException {
		synchronized (checkClosed().getConnectionMutex()) {
			return ((this.results != null) && this.results.reallyResult()) ? (ResultSet) this.results
					: null;
		}
	}
	...
	/**
	 * @see com.mysql.jdbc.StatementImpl#getResultSetHoldability()
	 */
