...
public class DatabaseMetaData implements java.sql.DatabaseMetaData {
	...
	private ResultSet buildResultSet(com.mysql.jdbc.Field[] fields,
			ArrayList<ResultSetRow> rows) throws SQLException {
		return buildResultSet(fields, rows, this.conn);
	}
	
	static ResultSet buildResultSet(com.mysql.jdbc.Field[] fields,
			ArrayList<ResultSetRow> rows, MySQLConnection c) throws SQLException {
